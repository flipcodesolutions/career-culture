...
class CustomAnnouncementSlider extends StatefulWidget {
  const CustomAnnouncementSlider({super.key});

  @override
  State<CustomAnnouncementSlider> createState() => _SliderRenderWidgetState();
}

class _SliderRenderWidgetState extends State<CustomAnnouncementSlider>
    with NavigateHelper {
  @override
  void initState() {
    ...
    return eventProvider.isLoading
        ...
        ? CustomContainer(
          child: CarouselSlider(
            items:
                eventProvider.eventModel?.data?.map((image) {
                    ...
                    child: CustomContainer(
                      ...
                      child: ClipRRect(
                        ...
                        child: CustomImageWithLoader(
                          ...
                          fit: BoxFit.cover,
                          imageUrl: "${AppStrings.assetsUrl}${image.poster}",
                        ),
                      ),
                    ),
                  );
